...
export interface _SERVICE {
  ...
  'createApiKey' : ActorMethod<[string], ApiKey>,
  'generateApiKeyForCaller' : ActorMethod<[], string>,
  'getCallerApiKey' : ActorMethod<[], [] | [string]>,
  ...
  'listApiKeysForCaller' : ActorMethod<[], Array<ApiKey>>,
